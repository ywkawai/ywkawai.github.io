...
#+BEGIN_EXPORT HTML
<p><img src="./img/ykawai_profile.JPG" alt="ykawai_profile.JPG" align="right" height="250">
#+END_EXPORT

** [#B] (2026 年 3 月 25 日 更新)
...
- 次世代気象気候モデルを念頭にした力学コアの高度化
 ...
 - 湿潤対流の数値収束性
 - [[https://ywkawai.github.io/FE-Project_web/][FE-Project]]: 不連続ガラーキン法を用いた流体計算ライブラリ, 大気モデル(SCALE-DG)の構築, 高精度力学コアと物理過程の結合手法の開発
 - 気象・気候計算のためのライブリ [[https://scale.riken.jp][SCALE]] 開発
